...
fun Fragment.getBoolean(key : String, defaultValue : Boolean = false) = arguments.getBoolean(key,
                                                                                             defaultValue)

fun Fragment.getString(key : String, defaultValue : String? = null) : String? = arguments.getString(
        key,
        defaultValue)
